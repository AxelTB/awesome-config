return { tools= require("utils.tools"),
-- clientSwitcher = require("utils.clientSwitcher"),
keyFunctions = require("utils.keyFunctions"),
mouseManager = require("utils.mouseManager"),
